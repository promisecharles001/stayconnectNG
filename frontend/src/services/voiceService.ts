import { createAgoraRtcEngine, IRtcEngine, RtcConnection, RtcStats, UserOfflineReasonType } from 'react-native-agora';
...
export class VoiceService {
  ...
  private setupEventListeners(): void {
    ...
    // User joined channel
    this.engine.addListener('onUserJoined', (connection: RtcConnection, uid: number, elapsed: number) => {
    ...
    this.engine.addListener('onConnectionStateChanged', (connection: RtcConnection, state: number, reason: number) => {
      console.log('Connection state changed:', state, reason);
    });

    // Audio volume indication
    this.engine.addListener('onAudioVolumeIndication', (connection: RtcConnection, speakers: unknown, speakerNumber: number, totalVolume: number) => {
